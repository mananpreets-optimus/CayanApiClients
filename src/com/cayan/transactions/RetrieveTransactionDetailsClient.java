 ...
 * to send in the original TransportKey and request additional payment information at a later time.
 */
public class RetrieveTransactionDetailsClient {
	...
	public static void main(String args[]) throws IOException {
		...
		String url ="https://simulator-genius.merchantware.net/v1/Reporting.asmx?wsdl";
		URL obj = new URL(url);
		/*
		 ...
		 */
		br = new BufferedReader(new FileReader("SoapRequestRetrieveTransaction.txt"));
