...
public class GiftAddValue {
	...
	public static void main(String args[]) throws IOException {
		...
		/*
		 * Soap Request is kept in SoapRequestGiftAddValue.txt and this request
		 * is read from file
		 */
		br = new BufferedReader(new FileReader("SoapRequestGiftAddValue"));
